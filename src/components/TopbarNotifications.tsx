...
const mockNotifications: NotificationItem[] = [
  {
    ...
    description: "Suas últimas alterações foram sincronizadas com sucesso.",
    time: "Agora mesmo",
    unread: true,
  },
  {
    id: "2",
    title: "Complete sua prontidão",
    description: "Preencha mais campos para melhorar as recomendações da TGPI.",
    time: "Há 5 min",
    unread: true,
  },
  {
    ...
    description: "Sua área de perfil agora conta com preview público e ações inteligentes.",
    time: "Hoje",
    unread: false,
  },
];
          ...
          <div className="mb-4 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-xs text-slate-400">
                Atualizações rápidas da sua conta e da plataforma
              </p>
            </div>
