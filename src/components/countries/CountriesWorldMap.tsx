...
export default function CountriesWorldMap({
  ...
  return (
    <div className="relative mt-5">
        ...
        {COUNTRY_MAP_REGIONS.map((region) => {
          ...
          return (
            <button
              ...
              className={`min-h-10 shrink-0 rounded-full border px-4 text-[10px] font-extrabold uppercase tracking-[0.1em] transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white ${
                isActive
      ...
      <div className="relative mt-3 h-[330px] overflow-hidden rounded-[26px] border border-white/12 bg-[#06172B] shadow-[inset_0_0_90px_rgba(56,113,158,.14)] sm:h-[410px] lg:h-[430px]">
        <svg
          ref={svgRef}
        ...
        >
          ...
          <defs>
            <linearGradient id="tgpi-map-water" x1="0" y1="0" x2="1" y2="1">
              <stop offset="0" stopColor="#071A32" />
              <stop offset="0.55" stopColor="#0B2744" />
