...
export function CountryCard({ country }: CountryCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-44 overflow-hidden bg-gradient-to-br from-[#111118] via-[#0B1F4D]/70 to-black">
        ...
        <div className="absolute left-5 top-5 flex items-center gap-2">
          <span className="rounded-full border border-white/10 bg-black/45 px-3 py-1 text-xs font-semibold text-slate-300 backdrop-blur">
            {country.region}
          </span>
        ...
        <div className="absolute bottom-5 left-5 right-5">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 truncate text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">
